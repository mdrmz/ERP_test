...
TAGS: List[TagDefinition] = [
    TagDefinition("KEPEK_BOS_KALIBRASYON", 2023, "bool", "coil", 1),
    TagDefinition("KEPEK_YUK_KALIBRASYON", 2024, "bool", "coil", 1),
    TagDefinition("KEPEK_GUNLUK_SIFIRLA", 2070, "bool", "coil", 1),
    TagDefinition("KEPEK_AYLIK_SIFIRLA", 2071, "bool", "coil", 1),
    TagDefinition("KEPEK_YILLIK_SIFIRLA", 2072, "bool", "coil", 1),
    TagDefinition("KEPEK_ALT_SENSOR", 2103, "bool", "coil", 1),
    TagDefinition("KEPEK_TOPLAM_DUN", 150, "float32", "holding", 2),
    TagDefinition("KEPEK_KG", 200, "float32", "holding", 2),
    TagDefinition("KEPEK_AKIS", 202, "float32", "holding", 2),
    TagDefinition("KEPEK_TOPLAM_1", 204, "float32", "holding", 2),
    TagDefinition("KEPEK_GUNLUK", 204, "float32", "holding", 2),
    TagDefinition("KEPEK_AYLIK", 206, "float32", "holding", 2),
    TagDefinition("KEPEK_YILLIK", 208, "float32", "holding", 2),
    TagDefinition("KEPEK_TOPLAM_2", 208, "float32", "holding", 2),
    TagDefinition("KEPEK_SET_DEGERI", 210, "float32", "holding", 2),
    TagDefinition("KEPEK_STABIL_SURESI", 212, "int16", "holding", 1),
    TagDefinition("KEPEK_ALT_KLEPE_KAPAT_SURESI", 214, "int16", "holding", 1),
    TagDefinition("KEPEK_START_SURESI", 216, "int16", "holding", 1),
    TagDefinition("KEPEK_YUK_DEGERI", 226, "float32", "holding", 2),
    TagDefinition("KEPEK_LD_DEGERI", 3840, "float64", "holding", 4),
]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="KEPEK PLC reader: live terminal output + CSV logging"
    )
    parser.add_argument("--ip", default="192.168.20.105", help="PLC IP address")
    ...
    parser.add_argument(
        "--csv", default="kepek_log.csv", help="CSV output path (default: kepek_log.csv)"
    )
    parser.add_argument(
        "--addr-shift",
        type=int,
    ...
    parser.add_argument(
        "--daily-report",
        default="kepek_daily_report.csv",
        help="Daily report CSV path (default: kepek_daily_report.csv)",
    )
    parser.add_argument(
        "--work-threshold",
        type=float,
        default=0.1,
        help="KEPEK_KG threshold for counting active runtime (default: 0.1)",
    )
    parser.add_argument(
        "--kg-max",
        type=float,
        default=100000.0,
        help="Ignore KEPEK_KG values above this limit in hourly/daily sum (default: 100000)",
    )
